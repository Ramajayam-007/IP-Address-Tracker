...
L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {
  attribution: `Developed by <a href="https://github.com/Ramajayam-007" target="_blank">Ramajayam M</a> and <a href="https://github.com/SanofarJahan" target="_blank">Sanofar Jahan</a>.`,
}).addTo(myMap)
...
const getData = (inputValue = '', searchType = 'IP') => {
  const url =
    searchType === 'IP'
	  ? `https://geo.ipify.org/api/v1?apiKey=at_9dpWogBACZk01rQjYm1sqEp8hYwnz&ipAddress=${inputValue}`
	  : `https://geo.ipify.org/api/v1?apiKey=at_9dpWogBACZk01rQjYm1sqEp8hYwnz&domain=${inputValue}`
